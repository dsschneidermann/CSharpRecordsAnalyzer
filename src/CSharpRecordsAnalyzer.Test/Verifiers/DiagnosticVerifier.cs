...
using System.Linq;
using System.Text;
using CSharpRecordsAnalyzer.Test.Helpers;
...
namespace CSharpRecordsAnalyzer.Test.Verifiers
{
    ...
    public abstract class DiagnosticVerifier
    {
                    ...
                    if (rule != null && rule.Id == diagnostics[i].Id)
                    {
                        ...
                        else
                        {
                            ...
                            builder.AppendFormat(
                                ...
                                linePosition.Character + 1, analyzerType.Name, rule.Id
                            );
                        }
        ...
        private void VerifyDiagnostics(
            string[] sources, string language, DiagnosticAnalyzer analyzer, params DiagnosticResult[] expected)
        {
        ...
        private static void VerifyDiagnosticResults(
            IEnumerable<Diagnostic> actualResults, DiagnosticAnalyzer analyzer,
        ...
        private static void VerifyDiagnosticLocation(
            DiagnosticAnalyzer analyzer, Diagnostic diagnostic, Location actual, DiagnosticResultLocation expected)
        {
